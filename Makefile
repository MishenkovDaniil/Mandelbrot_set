...
not_optimized: mandelbrot.cpp
		$(CC) $(Flags) mandelbrot.cpp -o not-optimized
		./not-optimized

optimized_1: mandelbrot_pseudo_optmzd_1.cpp
		$(CC) $(Flags) mandelbrot_pseudo_optmzd_1.cpp -o pseudo-optimized-1
		./pseudo-optimized-1

optimized_2: mandelbrot_pseudo_optmzd_2.cpp
		$(CC) $(Flags) mandelbrot_pseudo_optmzd_2.cpp -o pseudo-optimized-2
		./pseudo-optimized-2

optimized_3: mandelbrot_optmzd_3.cpp
		$(CC) $(Flags) mandelbrot_optmzd_3.cpp -o optimized
		./optimized